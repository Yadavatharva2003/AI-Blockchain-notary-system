        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSignUp}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className={`w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm ${darkMode ? 'text-white bg-purple-600 hover:bg-purple-700' : 'text-gray-700 bg-white hover:bg-gray-50'} transition-all duration-300`}
            >
