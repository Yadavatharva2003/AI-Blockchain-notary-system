          ...
          <ul>
            <li
              className={`cursor-pointer p-2 rounded-md hover:bg-gray-200 ${
                activeSection === "userDetails" ? "bg-gray-200" : ""
              }`}
            ...
            <li
              className={`cursor-pointer p-2 rounded-md hover:bg-gray-200 ${
                activeSection === "profileSettings" ? "bg-gray-200" : ""
              }`}
              onClick={() => handleSectionChange("profileSettings")}
            >
              Profile Settings
            </li>
            <li
              className={`cursor-pointer p-2 rounded-md hover:bg-gray-200 ${
                activeSection === "notificationPreferences" ? "bg-gray-200" : ""
              }`}
              onClick={() => handleSectionChange("notificationPreferences")}
            >
              Notification Preferences
            </li>
            <li
              className={`cursor-pointer p-2 rounded-md hover:bg-gray-200 ${
                activeSection === "privacySettings" ? "bg-gray-200" : ""
              }`}
              onClick={() => handleSectionChange("privacySettings")}
            >
              Privacy Settings
            </li>
          </ul>
